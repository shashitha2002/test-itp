...
const Edit = () => {
 ...
 const navigate = useNavigate();
  ...
  const submitUserData = async(e) => {
    ...
    const { fname, lname, email, mobile, gender, location,password } = inputdata;
            ...
            <Form>
              <Row>
                ...
                <Form.Group className="mb-3 col-lg-6" controlId="formBasicEmail">
                  ...
                  <Form.Control type="password" name='password' value={inputdata.password} onChange={setInputValue} placeholder='Enter Password' />
                </Form.Group>
